...
База данных состоит из 8 основных таблиц, которые хранят информацию о пользователях, упражнениях, шаблонах тренировок и истории тренировок.
...
### 6. `workout_sessions` - Сессии тренировок
...
### 8. `workout_sets_data` - Данные о подходах
