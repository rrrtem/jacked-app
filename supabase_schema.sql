...
-- Вставляем базовые упражнения
INSERT INTO exercises (name, instructions, tags) VALUES 
  ('Push-ups', 'Классические отжимания от пола. Держите корпус прямым, опускайтесь до касания грудью пола.', ARRAY['push', 'chest', 'triceps', 'bodyweight']),
  ('Pull-ups', 'Подтягивания на турнике. Подтягивайтесь до подбородка выше перекладины.', ARRAY['pull', 'back', 'biceps', 'bodyweight']),
  ('Squats', 'Приседания. Опускайтесь до параллели бедра с полом или ниже.', ARRAY['legs', 'full-body', 'bodyweight']),
  ('Bench Press', 'Жим штанги лёжа. Опускайте штангу до касания груди.', ARRAY['push', 'chest', 'triceps', 'barbell']),
  ('Deadlift', 'Становая тяга. Поднимайте штангу с пола, держа спину прямой.', ARRAY['pull', 'back', 'legs', 'full-body', 'barbell']),
  ('Overhead Press', 'Жим штанги стоя. Поднимайте штангу над головой.', ARRAY['push', 'shoulders', 'triceps', 'barbell']),
  ('Barbell Row', 'Тяга штанги в наклоне. Тяните штангу к нижней части груди.', ARRAY['pull', 'back', 'biceps', 'barbell']),
  ('Dips', 'Отжимания на брусьях. Опускайтесь до угла 90 градусов в локтях.', ARRAY['push', 'chest', 'triceps', 'bodyweight']),
  ('Lunges', 'Выпады. Делайте шаг вперёд и опускайтесь до угла 90 градусов.', ARRAY['legs', 'bodyweight']),
  ('Plank', 'Планка. Держите корпус прямым в упоре на предплечьях.', ARRAY['core', 'bodyweight'])
ON CONFLICT DO NOTHING;

-- Создаём тестовый шаблон тренировки
INSERT INTO workout_sets (id, user_id, name, description) VALUES 
  ('00000000-0000-0000-0000-000000000010', '00000000-0000-0000-0000-000000000001', 'Full Body Workout', 'Базовая тренировка на всё тело')
ON CONFLICT (id) DO NOTHING;
...
SELECT 
  ...
  90
FROM exercises e
WHERE e.name IN ('Push-ups', 'Squats', 'Pull-ups')
ON CONFLICT DO NOTHING;
